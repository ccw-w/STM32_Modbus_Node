...
typedef struct {
  uint16_t CAN_FilterIdHigh; /*!< Specifies the filter identification number
                                (MSBs for a 32-bit configuration, first one for
                                a 16-bit configuration). This parameter can be a
  ...
  uint16_t CAN_FilterMaskIdHigh; /*!< Specifies the filter mask number or
                                    ...
                                    can be a value between 0x0000 and 0xFFFF */

  uint16_t CAN_FilterMaskIdLow; /*!< Specifies the filter mask number or
                                   identification number, according to the mode
  ...
  uint16_t
      CAN_FilterFIFOAssignment; /*!< Specifies the FIFO (0 or 1) which will be
                                   assigned to the filter. This parameter can be
                                   a value of @ref CAN_filter_FIFO */
  ...
  FunctionalState CAN_FilterActivation; /*!< Enable or disable the filter.
                                              This parameter can be set either
                                           to ENABLE or DISABLE. */
...
#define CAN_Mode_Silent_LoopBack                                               \
  ((uint8_t)0x03) /*!< loopback combined with silent mode */

#define IS_CAN_MODE(MODE)                                                      \
  (((MODE) == CAN_Mode_Normal) || ((MODE) == CAN_Mode_LoopBack) ||             \
...
#define CAN_ModeStatus_Failed                                                  \
  ((uint8_t)0x00) /*!< CAN entering the specific mode failed */
#define CAN_ModeStatus_Success                                                 \
  ((uint8_t)!CAN_ModeStatus_Failed) /*!< CAN entering the specific mode        \
                                       Succeed */
...
#define CAN_Filter_FIFO0                                                       \
  ((uint8_t)0x00) /*!< Filter FIFO 0 assignment for filter x */
#define CAN_Filter_FIFO1                                                       \
  ((uint8_t)0x01) /*!< Filter FIFO 1 assignment for filter x */
...
#define CAN_TxStatus_NoMailBox                                                 \
  ((uint8_t)0x04) /*!< CAN cell did not provide an empty mailbox */
...
#define CAN_ErrorCode_BitRecessiveErr                                          \
  ((uint8_t)0x40)                                    /*!< Bit Recessive Error */
...
/* Note: When SLAK intterupt is disabled (SLKIE=0), no polling on SLAKI is
...
#define CAN_IT_TME                                                             \
  ((uint32_t)0x00000001) /*!< Transmit mailbox empty Interrupt*/
...
#define CAN_IT_FMP1                                                            \
  ((uint32_t)0x00000010) /*!< FIFO 1 message pending Interrupt*/
...
#define IS_CAN_IT(IT)                                                          \
  (((IT) == CAN_IT_TME) || ((IT) == CAN_IT_FMP0) || ((IT) == CAN_IT_FF0) ||    \
   ((IT) == CAN_IT_FOV0) || ((IT) == CAN_IT_FMP1) || ((IT) == CAN_IT_FF1) ||   \
   ((IT) == CAN_IT_FOV1) || ((IT) == CAN_IT_EWG) || ((IT) == CAN_IT_EPV) ||    \
   ((IT) == CAN_IT_BOF) || ((IT) == CAN_IT_LEC) || ((IT) == CAN_IT_ERR) ||     \
   ((IT) == CAN_IT_WKU) || ((IT) == CAN_IT_SLK))

#define IS_CAN_CLEAR_IT(IT)                                                    \
  (((IT) == CAN_IT_TME) || ((IT) == CAN_IT_FF0) || ((IT) == CAN_IT_FOV0) ||    \
   ((IT) == CAN_IT_FF1) || ((IT) == CAN_IT_FOV1) || ((IT) == CAN_IT_EWG) ||    \
   ((IT) == CAN_IT_EPV) || ((IT) == CAN_IT_BOF) || ((IT) == CAN_IT_LEC) ||     \
   ((IT) == CAN_IT_ERR) || ((IT) == CAN_IT_WKU) || ((IT) == CAN_IT_SLK))
