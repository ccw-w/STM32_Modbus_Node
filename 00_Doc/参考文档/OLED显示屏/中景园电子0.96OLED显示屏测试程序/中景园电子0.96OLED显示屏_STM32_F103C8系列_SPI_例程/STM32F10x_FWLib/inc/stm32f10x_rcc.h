...
typedef struct {
  uint32_t
      SYSCLK_Frequency; /*!< returns SYSCLK clock frequency expressed in Hz */
  uint32_t HCLK_Frequency; /*!< returns HCLK clock frequency expressed in Hz */
  uint32_t
      PCLK1_Frequency; /*!< returns PCLK1 clock frequency expressed in Hz */
  uint32_t
      PCLK2_Frequency; /*!< returns PCLK2 clock frequency expressed in Hz */
  uint32_t
      ADCCLK_Frequency; /*!< returns ADCCLK clock frequency expressed in Hz */
} RCC_ClocksTypeDef;
...
#define IS_RCC_PLL_SOURCE(SOURCE)                                              \
  (((SOURCE) == RCC_PLLSource_HSI_Div2) || ((SOURCE) == RCC_PLLSource_PREDIV1))
#endif /* STM32F10X_CL */
...
#define IS_RCC_PREDIV2(PREDIV2)                                                \
  (((PREDIV2) == RCC_PREDIV2_Div1) || ((PREDIV2) == RCC_PREDIV2_Div2) ||       \
...
#define IS_RCC_PLL2_MUL(MUL)                                                   \
  (((MUL) == RCC_PLL2Mul_8) || ((MUL) == RCC_PLL2Mul_9) ||                     \
...
#define IS_RCC_PLL3_MUL(MUL)                                                   \
  (((MUL) == RCC_PLL3Mul_8) || ((MUL) == RCC_PLL3Mul_9) ||                     \
...
#define IS_RCC_OTGFSCLK_SOURCE(SOURCE)                                         \
  (((SOURCE) == RCC_OTGFSCLKSource_PLLVCO_Div3) ||                             \
...
#define IS_RCC_I2S2CLK_SOURCE(SOURCE)                                          \
  (((SOURCE) == RCC_I2S2CLKSource_SYSCLK) ||                                   \
...
#define IS_RCC_I2S3CLK_SOURCE(SOURCE)                                          \
  (((SOURCE) == RCC_I2S3CLKSource_SYSCLK) ||                                   \
...
#define IS_RCC_LSE(LSE)                                                        \
  (((LSE) == RCC_LSE_OFF) || ((LSE) == RCC_LSE_ON) || ((LSE) == RCC_LSE_Bypass))
/**
 * @}
 */
...
#define IS_RCC_AHB_PERIPH_RESET(PERIPH)                                        \
