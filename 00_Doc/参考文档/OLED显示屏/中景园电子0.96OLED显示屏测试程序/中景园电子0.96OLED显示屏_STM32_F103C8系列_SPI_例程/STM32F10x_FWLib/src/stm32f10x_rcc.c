...
#define CR_PLL2ON_BB                                                           \
  (PERIPH_BB_BASE + (CR_OFFSET * 32) + (PLL2ON_BitNumber * 4))

/* Alias word address of PLL3ON bit */
#define PLL3ON_BitNumber 0x1C
#define CR_PLL3ON_BB                                                           \
  (PERIPH_BB_BASE + (CR_OFFSET * 32) + (PLL3ON_BitNumber * 4))
#endif /* STM32F10X_CL */
...
#define CFGR_USBPRE_BB                                                         \
  (PERIPH_BB_BASE + (CFGR_OFFSET * 32) + (USBPRE_BitNumber * 4))
#else
#define OTGFSPRE_BitNumber 0x16
#define CFGR_OTGFSPRE_BB                                                       \
  (PERIPH_BB_BASE + (CFGR_OFFSET * 32) + (OTGFSPRE_BitNumber * 4))
#endif /* STM32F10X_CL */
...
#define CFGR2_I2S2SRC_BB                                                       \
  (PERIPH_BB_BASE + (CFGR2_OFFSET * 32) + (I2S2SRC_BitNumber * 4))

/* Alias word address of I2S3SRC bit */
#define I2S3SRC_BitNumber 0x12
#define CFGR2_I2S3SRC_BB                                                       \
  (PERIPH_BB_BASE + (CFGR2_OFFSET * 32) + (I2S3SRC_BitNumber * 4))
#endif /* STM32F10X_CL */
...
static __I uint8_t APBAHBPrescTable[16] = {0, 0, 0, 0, 1, 2, 3, 4,
                                           1, 2, 3, 4, 6, 7, 8, 9};
 ...
 * @note   HSE can not be stopped if it is used directly or through the PLL as
 * system clock.
 ...
 * @note   HSI can not be stopped if it is used directly or through the PLL as
 * system clock.
 * @param  NewState: new state of the HSI. This parameter can be: ENABLE or
 * DISABLE.
 * @retval None
 */
 ...
 *   this parameter can be one of the following values:
 *     @arg RCC_PLLSource_HSI_Div2: HSI oscillator clock divided by 2 selected
 * as PLL clock entry
 *     @arg RCC_PLLSource_PREDIV1: PREDIV1 clock selected as PLL clock entry
 *   For @b other_STM32_devices, this parameter can be one of the following
 * values:
 *     @arg RCC_PLLSource_HSI_Div2: HSI oscillator clock divided by 2 selected
 * as PLL clock entry
 *     @arg RCC_PLLSource_HSE_Div1: HSE oscillator clock selected as PLL clock
 * entry
 *     @arg RCC_PLLSource_HSE_Div2: HSE oscillator clock divided by 2 selected
 * as PLL clock entry
 * @param  RCC_PLLMul: specifies the PLL multiplication factor.
 *   For @b STM32_Connectivity_line_devices, this parameter can be RCC_PLLMul_x
 * where x:{[4,9], 6_5} For @b other_STM32_devices, this parameter can be
 ...
 * @param  NewState: new state of the PLL. This parameter can be: ENABLE or
 * DISABLE.
 * @retval None
 */
 ...
 * @note
 *   For @b STM32_Value_line_devices this parameter is always
 ...
 *   - This function applies only to STM32 Connectivity line devices.
 * @param  NewState: new state of the PLL2. This parameter can be: ENABLE or
 * DISABLE.
 * @retval None
 */
 ...
 * @param  NewState: new state of the PLL3. This parameter can be: ENABLE or
 * DISABLE.
 * @retval None
 */
 ...
 * @param  RCC_IT: specifies the RCC interrupt sources to be enabled or
 * disabled.
 *
 ...
 *   This parameter can be one of the following values:
 *     @arg RCC_USBCLKSource_PLLCLK_1Div5: PLL clock divided by 1,5 selected as
 * USB clock source
 ...
 *   This parameter can be one of the following values:
 *     @arg  RCC_OTGFSCLKSource_PLLVCO_Div3: PLL VCO clock divided by 2 selected
 * as USB OTG FS clock source
 *     @arg  RCC_OTGFSCLKSource_PLLVCO_Div2: PLL VCO clock divided by 2 selected
 * as USB OTG FS clock source
 * @retval None
 */
 ...
 *     @arg RCC_I2S2CLKSource_PLL3_VCO: PLL3 VCO clock selected as I2S2 clock
 * entry
 * @retval None
 */
 ...
 *     @arg RCC_I2S3CLKSource_PLL3_VCO: PLL3 VCO clock selected as I2S3 clock
 * entry
 * @retval None
 */
 ...
 * @param  NewState: new state of the LSI. This parameter can be: ENABLE or
 * DISABLE.
 * @retval None
 */
 ...
 * @note   Once the RTC clock is selected it can't be changed unless the Backup
 * domain is reset.
 * @param  RCC_RTCCLKSource: specifies the RTC clock source.
 *   This parameter can be one of the following values:
 *     @arg RCC_RTCCLKSource_LSE: LSE selected as RTC clock
 *     @arg RCC_RTCCLKSource_LSI: LSI selected as RTC clock
 *     @arg RCC_RTCCLKSource_HSE_Div128: HSE clock divided by 128 selected as
 * RTC clock
 * @retval None
 */
 ...
 * @note   This function must be used only after the RTC clock was selected
 * using the RCC_RTCCLKConfig function.
 * @param  NewState: new state of the RTC clock. This parameter can be: ENABLE
 * or DISABLE.
 * @retval None
 */
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef *RCC_Clocks) {
  ...
  case 0x08: /* PLL used as system clock */
    ...
    if (pllsource == 0x00) { /* HSI oscillator clock divided by 2 selected as
                                PLL clock entry */
    ...
    defined(STM32F10X_HD_VL)
      ...
      if ((RCC->CFGR & CFGR_PLLXTPRE_Mask) !=
 ...
 * @note   The reset flags are: RCC_FLAG_PINRST, RCC_FLAG_PORRST,
