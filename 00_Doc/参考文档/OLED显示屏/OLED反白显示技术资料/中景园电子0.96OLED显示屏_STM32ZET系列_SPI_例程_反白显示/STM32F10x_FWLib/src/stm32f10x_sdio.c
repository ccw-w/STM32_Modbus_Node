...
void SDIO_Init(SDIO_InitTypeDef *SDIO_InitStruct) {
  ...
  assert_param(
      IS_SDIO_HARDWARE_FLOW_CONTROL(SDIO_InitStruct->SDIO_HardwareFlowControl));
 ...
 * @param  NewState: new state of the SDIO Clock. This parameter can be: ENABLE
 * or DISABLE.
 * @retval None
 */
 ...
 * @param  SDIO_IT: specifies the SDIO interrupt sources to be enabled or
 * disabled. This parameter can be one or a combination of the following values:
...
void SDIO_SendCommand(SDIO_CmdInitTypeDef *SDIO_CmdInitStruct) {
  ...
  tmpreg |= (uint32_t)SDIO_CmdInitStruct->SDIO_CmdIndex |
            SDIO_CmdInitStruct->SDIO_Response | SDIO_CmdInitStruct->SDIO_Wait |
 ...
 */
uint32_t SDIO_GetDataCounter(void) { return SDIO->DCOUNT; }
 ...
 */
uint32_t SDIO_ReadData(void) { return SDIO->FIFO; }
 ...
 * @retval None
 */
void SDIO_WriteData(uint32_t Data) { SDIO->FIFO = Data; }
 ...
 */
uint32_t SDIO_GetFIFOCount(void) { return SDIO->FIFOCNT; }
 ...
 * @param  NewState: new state of CE-ATA interrupt. This parameter can be:
 * ENABLE or DISABLE.
 * @retval None
 */
 ...
 * @param  NewState: new state of CE-ATA command. This parameter can be: ENABLE
 * or DISABLE.
 * @retval None
 */
 ...
 *     @arg SDIO_FLAG_STBITERR: Start bit not detected on all data signals in
 * wide bus mode.
 ...
 *     @arg SDIO_FLAG_CEATAEND: CE-ATA command completion signal received for
 * CMD61
