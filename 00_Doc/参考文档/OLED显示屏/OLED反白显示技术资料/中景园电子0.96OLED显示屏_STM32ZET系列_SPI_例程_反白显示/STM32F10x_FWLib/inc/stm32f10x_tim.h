...
typedef struct {
  ...
  uint16_t TIM_Period; /*!< Specifies the period value to be loaded into the
  ...
  uint8_t
      TIM_RepetitionCounter; /*!< Specifies the repetition counter value. Each
                                time the RCR downcounter reaches zero, an update
                                event is generated and counting restarts from
                                the RCR value (N). This means in PWM mode that
                                (N+1) corresponds to:
                                     - the number of PWM periods in edge-aligned
                                mode
                                     - the number of half PWM period in
                                center-aligned mode This parameter must be a
...
typedef struct {
  ...
  uint16_t TIM_OutputNState; /*!< Specifies the TIM complementary Output Compare
                                state. This parameter can be a value of @ref
                                TIM_Output_Compare_N_state
                                  @note This parameter is valid only for TIM1
                                and TIM8. */

  uint16_t TIM_Pulse; /*!< Specifies the pulse value to be loaded into the
...
typedef struct {
  ...
  uint16_t TIM_OSSRState; /*!< Specifies the Off-State selection used in Run
  ...
  uint16_t
      TIM_LOCKLevel; /*!< Specifies the LOCK level parameters.
                          This parameter can be a value of @ref Lock_level */

  uint16_t TIM_DeadTime; /*!< Specifies the delay time between the switching-off
                            and the switching-on of the outputs. This parameter
                            can be a number between 0x00 and 0xFF  */

  uint16_t TIM_Break; /*!< Specifies whether the TIM Break input is enabled or
  ...
  uint16_t TIM_AutomaticOutput; /*!< Specifies whether the TIM Automatic Output
                                   feature is enabled or not. This parameter can
                                   be a value of @ref TIM_AOE_Bit_Set_Reset */
} TIM_BDTRInitTypeDef;
...
#define IS_TIM_ALL_PERIPH(PERIPH)                                              \
  (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) ||           \
   ...
   ((PERIPH) == TIM13) || ((PERIPH) == TIM14) || ((PERIPH) == TIM15) ||        \
   ((PERIPH) == TIM16) || ((PERIPH) == TIM17))
...
#define IS_TIM_LIST2_PERIPH(PERIPH)                                            \
  (((PERIPH) == TIM1) || ((PERIPH) == TIM8) || ((PERIPH) == TIM15) ||          \
   ((PERIPH) == TIM16) || ((PERIPH) == TIM17))
...
#define IS_TIM_LIST4_PERIPH(PERIPH)                                            \
  (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) ||           \
   ((PERIPH) == TIM4) || ((PERIPH) == TIM5) || ((PERIPH) == TIM8) ||           \
   ((PERIPH) == TIM15) || ((PERIPH) == TIM16) || ((PERIPH) == TIM17))
...
#define IS_TIM_LIST6_PERIPH(PERIPH)                                            \
  (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) ||           \
   ((PERIPH) == TIM4) || ((PERIPH) == TIM5) || ((PERIPH) == TIM8) ||           \
   ((PERIPH) == TIM9) || ((PERIPH) == TIM12) || ((PERIPH) == TIM15))
...
#define IS_TIM_LIST9_PERIPH(PERIPH)                                            \
  (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) ||           \
   ((PERIPH) == TIM4) || ((PERIPH) == TIM5) || ((PERIPH) == TIM6) ||           \
   ((PERIPH) == TIM7) || ((PERIPH) == TIM8) || ((PERIPH) == TIM15) ||          \
   ((PERIPH) == TIM16) || ((PERIPH) == TIM17))
...
#define IS_TIM_GET_IT(IT)                                                      \
  (((IT) == TIM_IT_Update) || ((IT) == TIM_IT_CC1) || ((IT) == TIM_IT_CC2) ||  \
   ((IT) == TIM_IT_CC3) || ((IT) == TIM_IT_CC4) || ((IT) == TIM_IT_COM) ||     \
...
#define IS_TIM_EXT_PRESCALER(PRESCALER)                                        \
  (((PRESCALER) == TIM_ExtTRGPSC_OFF) ||                                       \
   ...
   ((PRESCALER) == TIM_ExtTRGPSC_DIV4) || ((PRESCALER) == TIM_ExtTRGPSC_DIV8))
/**
 * @}
 */
...
#define IS_TIM_TRGO_SOURCE(SOURCE)                                             \
  (((SOURCE) == TIM_TRGOSource_Reset) ||                                       \
   ...
   ((SOURCE) == TIM_TRGOSource_Update) || ((SOURCE) == TIM_TRGOSource_OC1) ||  \
   ((SOURCE) == TIM_TRGOSource_OC1Ref) ||                                      \
   ((SOURCE) == TIM_TRGOSource_OC2Ref) ||                                      \
   ((SOURCE) == TIM_TRGOSource_OC3Ref) || ((SOURCE) == TIM_TRGOSource_OC4Ref))
/**
 * @}
 */
