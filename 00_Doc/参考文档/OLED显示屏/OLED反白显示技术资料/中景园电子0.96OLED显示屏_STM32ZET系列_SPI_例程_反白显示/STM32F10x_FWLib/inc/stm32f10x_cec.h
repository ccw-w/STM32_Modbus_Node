 ...
 * @{
 */
#define CEC_BitTimingStdMode                                                   \
  ((uint16_t)0x00) /*!< Bit timing error Standard Mode */
#define CEC_BitTimingErrFreeMode                                               \
  CEC_CFGR_BTEM /*!< Bit timing error Free Mode */
 ...
 * @{
 */
#define CEC_BitPeriodStdMode                                                   \
  ((uint16_t)0x00) /*!< Bit period error Standard Mode */
#define CEC_BitPeriodFlexibleMode                                              \
  CEC_CFGR_BPEM /*!< Bit period error Flexible Mode */
