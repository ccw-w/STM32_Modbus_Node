...
typedef struct {
  uint32_t USART_BaudRate; /*!< This member configures the USART communication
                              baud rate. The baud rate is computed using the
                              following formula:
                                 - IntegerDivider = ((PCLKx) / (16 *
                              (USART_InitStruct->USART_BaudRate)))
                                 - FractionalDivider = ((IntegerDivider - ((u32)
                              IntegerDivider)) * 16) + 0.5 */

  uint16_t USART_WordLength; /*!< Specifies the number of data bits transmitted
                                or received in a frame. This parameter can be a
                                value of @ref USART_Word_Length */
  ...
  uint16_t
      USART_Parity; /*!< Specifies the parity mode.
  ...
  uint16_t USART_Mode; /*!< Specifies wether the Receive or Transmit mode is
...
typedef struct {
  ...
  uint16_t USART_Clock; /*!< Specifies whether the USART clock is enabled or
                           disabled. This parameter can be a value of @ref
                           USART_Clock */

  uint16_t USART_CPOL; /*!< Specifies the steady state value of the serial
                          clock. This parameter can be a value of @ref
                          USART_Clock_Polarity */

  uint16_t USART_CPHA; /*!< Specifies the clock transition on which the bit
                          capture is made. This parameter can be a value of @ref
                          USART_Clock_Phase */

  uint16_t USART_LastBit; /*!< Specifies whether the clock pulse corresponding
                             to the last transmitted data bit (MSB) has to be
                             output on the SCLK pin in synchronous mode. This
                             parameter can be a value of @ref USART_Last_Bit */
...
#define IS_USART_ALL_PERIPH(PERIPH)                                            \
  (((PERIPH) == USART1) || ((PERIPH) == USART2) || ((PERIPH) == USART3) ||     \
...
#define IS_USART_WORD_LENGTH(LENGTH)                                           \
  (((LENGTH) == USART_WordLength_8b) || ((LENGTH) == USART_WordLength_9b))
/**
 * @}
 */
...
#define IS_USART_STOPBITS(STOPBITS)                                            \
  (((STOPBITS) == USART_StopBits_1) || ((STOPBITS) == USART_StopBits_0_5) ||   \
   ((STOPBITS) == USART_StopBits_2) || ((STOPBITS) == USART_StopBits_1_5))
/**
 * @}
 */
...
#define IS_USART_CONFIG_IT(IT)                                                 \
  (((IT) == USART_IT_PE) || ((IT) == USART_IT_TXE) || ((IT) == USART_IT_TC) || \
   ((IT) == USART_IT_RXNE) || ((IT) == USART_IT_IDLE) ||                       \
   ((IT) == USART_IT_LBD) || ((IT) == USART_IT_CTS) || ((IT) == USART_IT_ERR))
#define IS_USART_GET_IT(IT)                                                    \
  (((IT) == USART_IT_PE) || ((IT) == USART_IT_TXE) || ((IT) == USART_IT_TC) || \
   ((IT) == USART_IT_RXNE) || ((IT) == USART_IT_IDLE) ||                       \
   ((IT) == USART_IT_LBD) || ((IT) == USART_IT_CTS) ||                         \
   ((IT) == USART_IT_ORE) || ((IT) == USART_IT_NE) || ((IT) == USART_IT_FE))
