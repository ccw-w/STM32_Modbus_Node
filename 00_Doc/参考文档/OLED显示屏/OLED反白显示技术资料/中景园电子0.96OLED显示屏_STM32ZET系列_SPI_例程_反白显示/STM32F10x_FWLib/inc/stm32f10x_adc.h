...
typedef struct {
  ...
  FunctionalState
      ADC_ScanConvMode; /*!< Specifies whether the conversion is performed in
                             Scan (multichannels) or Single (one channel) mode.
                             This parameter can be set to ENABLE or DISABLE */

  FunctionalState ADC_ContinuousConvMode; /*!< Specifies whether the conversion
                                             is performed in Continuous or
                                             Single mode. This parameter can be
                                             set to ENABLE or DISABLE. */

  uint32_t
      ADC_ExternalTrigConv; /*!< Defines the external trigger used to start the
                               analog to digital conversion of regular channels.
                               This parameter can be a value of @ref
                               ADC_external_trigger_sources_for_regular_channels_conversion
                             */

  uint32_t ADC_DataAlign; /*!< Specifies whether the ADC data alignment is left
                             or right. This parameter can be a value of @ref
                             ADC_data_align */

  uint8_t
      ADC_NbrOfChannel; /*!< Specifies the number of ADC channels that will be
                           converted using the sequencer for regular channel
                           group. This parameter must range from 1 to 16. */
} ADC_InitTypeDef;
/**
 * @}
 */
...
#define IS_ADC_MODE(MODE)                                                      \
  (((MODE) == ADC_Mode_Independent) || ((MODE) == ADC_Mode_RegInjecSimult) ||  \
   ((MODE) == ADC_Mode_RegSimult_AlterTrig) ||                                 \
   ((MODE) == ADC_Mode_InjecSimult_FastInterl) ||                              \
   ((MODE) == ADC_Mode_InjecSimult_SlowInterl) ||                              \
   ((MODE) == ADC_Mode_InjecSimult) || ((MODE) == ADC_Mode_RegSimult) ||       \
   ((MODE) == ADC_Mode_FastInterl) || ((MODE) == ADC_Mode_SlowInterl) ||       \
...
#define ADC_ExternalTrigConv_Ext_IT11_TIM8_TRGO                                \
  ((uint32_t)0x000C0000) /*!< For ADC1 and ADC2 */

#define ADC_ExternalTrigConv_T1_CC3                                            \
  ((uint32_t)0x00040000) /*!< For ADC1, ADC2 and ADC3 */
...
#define ADC_ExternalTrigInjecConv_T2_TRGO                                      \
  ((uint32_t)0x00002000) /*!< For ADC1 and ADC2 */
#define ADC_ExternalTrigInjecConv_T2_CC1                                       \
  ((uint32_t)0x00003000) /*!< For ADC1 and ADC2 */
#define ADC_ExternalTrigInjecConv_T3_CC4                                       \
  ((uint32_t)0x00004000) /*!< For ADC1 and ADC2 */
#define ADC_ExternalTrigInjecConv_T4_TRGO                                      \
  ((uint32_t)0x00005000) /*!< For ADC1 and ADC2 */
#define ADC_ExternalTrigInjecConv_Ext_IT15_TIM8_CC4                            \
  ((uint32_t)0x00006000) /*!< For ADC1 and ADC2 */

#define ADC_ExternalTrigInjecConv_T1_TRGO                                      \
  ((uint32_t)0x00000000) /*!< For ADC1, ADC2 and ADC3 */
#define ADC_ExternalTrigInjecConv_T1_CC4                                       \
  ((uint32_t)0x00001000) /*!< For ADC1, ADC2 and ADC3 */
#define ADC_ExternalTrigInjecConv_None                                         \
  ((uint32_t)0x00007000) /*!< For ADC1, ADC2 and ADC3 */

#define ADC_ExternalTrigInjecConv_T4_CC3                                       \
  ((uint32_t)0x00002000) /*!< For ADC3 only */
#define ADC_ExternalTrigInjecConv_T8_CC2                                       \
  ((uint32_t)0x00003000) /*!< For ADC3 only */
#define ADC_ExternalTrigInjecConv_T8_CC4                                       \
  ((uint32_t)0x00004000) /*!< For ADC3 only */
#define ADC_ExternalTrigInjecConv_T5_TRGO                                      \
  ((uint32_t)0x00005000) /*!< For ADC3 only */
#define ADC_ExternalTrigInjecConv_T5_CC4                                       \
  ((uint32_t)0x00006000) /*!< For ADC3 only */
...
#define IS_ADC_GET_IT(IT)                                                      \
  (((IT) == ADC_IT_EOC) || ((IT) == ADC_IT_AWD) || ((IT) == ADC_IT_JEOC))
/**
 * @}
 */
...
#define IS_ADC_CLEAR_FLAG(FLAG)                                                \
  ((((FLAG) & (uint8_t)0xE0) == 0x00) && ((FLAG) != 0x00))
