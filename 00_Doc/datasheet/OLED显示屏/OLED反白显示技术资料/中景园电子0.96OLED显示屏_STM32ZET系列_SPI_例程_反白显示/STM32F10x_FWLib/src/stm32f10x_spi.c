...
void SPI_Init(SPI_TypeDef *SPIx, SPI_InitTypeDef *SPI_InitStruct) {
  ...
  tmpreg = SPIx->CR1;
  /* Clear BIDIMode, BIDIOE, RxONLY, SSM, SSI, LSBFirst, BR, MSTR, CPOL and CPHA
   * bits */
  tmpreg &= CR1_CLEAR_Mask;
  /* Configure SPIx: direction, NSS management, first transmitted bit, BaudRate
     prescaler master/salve mode, CPOL and CPHA */
 ...
 * @param  SPI_InitStruct : pointer to a SPI_InitTypeDef structure which will be
 * initialized.
 * @retval None
 */
 ...
 * @param  I2S_InitStruct : pointer to a I2S_InitTypeDef structure which will be
 * initialized.
 * @retval None
 */
 ...
 *   - 2 or 3 in I2S mode
 * @param  SPI_I2S_IT: specifies the SPI/I2S interrupt source to be enabled or
 ...
 *   - 1, 2 or 3 in SPI mode
 *   - 2 or 3 in I2S mode
 * @param  SPI_I2S_DMAReq: specifies the SPI/I2S DMA transfer request to be
 * enabled or disabled. This parameter can be any combination of the following
 * values:
...
/**
 * @brief  Enables or disables the CRC value calculation of the transferred
 * bytes.
 * @param  SPIx: where x can be 1, 2 or 3 to select the SPI peripheral.
...
/**
 * @brief  Returns the transmit or the receive CRC register value for the
 * specified SPI.
 * @param  SPIx: where x can be 1, 2 or 3 to select the SPI peripheral.
...
/**
 * @brief  Selects the data transfer direction in bi-directional mode for the
 * specified SPI.
 * @param  SPIx: where x can be 1, 2 or 3 to select the SPI peripheral.
 * @param  SPI_Direction: specifies the data transfer direction in
 * bi-directional mode. This parameter can be one of the following values:
