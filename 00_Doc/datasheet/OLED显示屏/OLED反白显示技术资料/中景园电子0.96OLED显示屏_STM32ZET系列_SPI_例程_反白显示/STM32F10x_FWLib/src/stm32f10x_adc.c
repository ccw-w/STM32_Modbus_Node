 ...
 * @param  Rank: The rank in the regular group sequencer. This parameter must be
 * between 1 to 16.
...
/**
 * @brief  Configures the ADCx external trigger for injected channels
 * conversion.
 * @param  ADCx: where x can be 1, 2 or 3 to select the ADC peripheral.
 * @param  ADC_ExternalTrigInjecConv: specifies the ADC trigger to start
 * injected conversion. This parameter can be one of the following values:
 *     @arg ADC_ExternalTrigInjecConv_T1_TRGO: Timer1 TRGO event selected (for
 * ADC1, ADC2 and ADC3)
 *     @arg ADC_ExternalTrigInjecConv_T1_CC4: Timer1 capture compare4 selected
 * (for ADC1, ADC2 and ADC3)
 *     @arg ADC_ExternalTrigInjecConv_T2_TRGO: Timer2 TRGO event selected (for
 * ADC1 and ADC2)
 ...
 * (for ADC1 and ADC2)
 *     @arg ADC_ExternalTrigInjecConv_T4_TRGO: Timer4 TRGO event selected (for
 * ADC1 and ADC2)
 *     @arg ADC_ExternalTrigInjecConv_Ext_IT15_TIM8_CC4: External interrupt line
 * 15 or Timer8 capture compare4 event selected (for ADC1 and ADC2)
 ...
 * (for ADC3 only)
 *     @arg ADC_ExternalTrigInjecConv_T5_TRGO: Timer5 TRGO event selected (for
 * ADC3 only)
 *     @arg ADC_ExternalTrigInjecConv_T5_CC4: Timer5 capture compare4 selected
 * (for ADC3 only)
 *     @arg ADC_ExternalTrigInjecConv_None: Injected conversion started by
 * software and not by external trigger (for ADC1, ADC2 and ADC3)
 * @retval None
 */
 ...
 *         channels conversion.
 * @param  ADCx: where x can be 1, 2 or 3 to select the ADC peripheral.
 * @param  NewState: new state of the selected ADC software start injected
 * conversion. This parameter can be: ENABLE or DISABLE.
 * @retval None
 */
void ADC_SoftwareStartInjectedConvCmd(ADC_TypeDef *ADCx,
  ...
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  if (NewState != DISABLE) {
    /* Enable the selected ADC conversion for injected group on external event
       and start the selected ADC injected conversion */
    ADCx->CR2 |= CR2_JEXTTRIG_JSWSTART_Set;
  } else {
    /* Disable the selected ADC conversion on external event for injected group
       and stop the selected ADC injected conversion */
 ...
 * @param  ADCx: where x can be 1, 2 or 3 to select the ADC peripheral.
 * @retval The new state of ADC software start injected conversion (SET or
 * RESET).
 */
 ...
 *     @arg ADC_Channel_16: ADC Channel16 selected
 *     @arg ADC_Channel_17: ADC Channel17 selected
 * @param  Rank: The rank in the injected group sequencer. This parameter must
 * be between 1 and 4.
 * @param  ADC_SampleTime: The sample time value to be set for the selected
 * channel. This parameter can be one of the following values:
 *     @arg ADC_SampleTime_1Cycles5: Sample time equal to 1.5 cycles
...
void ADC_InjectedChannelConfig(ADC_TypeDef *ADCx, uint8_t ADC_Channel,
  ...
  tmpreg2 = (uint32_t)ADC_Channel
            << (5 * (uint8_t)((Rank + 3) - (tmpreg3 + 1)));
