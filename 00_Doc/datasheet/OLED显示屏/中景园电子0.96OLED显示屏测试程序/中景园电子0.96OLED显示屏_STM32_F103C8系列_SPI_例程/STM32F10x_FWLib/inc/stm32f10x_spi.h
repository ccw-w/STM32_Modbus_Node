...
typedef struct {
  uint16_t SPI_Direction; /*!< Specifies the SPI unidirectional or bidirectional
                             data mode. This parameter can be a value of @ref
                             SPI_data_direction */
  ...
  uint16_t
      SPI_CPOL; /*!< Specifies the serial clock steady state.
                     This parameter can be a value of @ref SPI_Clock_Polarity */

  uint16_t
      SPI_CPHA; /*!< Specifies the clock active edge for the bit capture.
  ...
  uint16_t
      SPI_BaudRatePrescaler; /*!< Specifies the Baud Rate prescaler value which
                                will be used to configure the transmit and
                                receive SCK clock. This parameter can be a value
                                of @ref SPI_BaudRate_Prescaler.
                                  @note The communication clock is derived from
                                the master clock. The slave clock does not need
                                to be set. */

  uint16_t SPI_FirstBit; /*!< Specifies whether data transfers start from MSB or
                            LSB bit. This parameter can be a value of @ref
                            SPI_MSB_LSB_transmission */

  uint16_t SPI_CRCPolynomial; /*!< Specifies the polynomial used for the CRC
                                 calculation. */
} SPI_InitTypeDef;
...
typedef struct {
  ...
  uint16_t I2S_MCLKOutput; /*!< Specifies whether the I2S MCLK output is enabled
                              or not. This parameter can be a value of @ref
                              I2S_MCLK_Output */
  ...
  uint16_t
      I2S_CPOL; /*!< Specifies the idle state of the I2S clock.
...
#define IS_I2S_STANDARD(STANDARD)                                              \
  (((STANDARD) == I2S_Standard_Phillips) ||                                    \
   ((STANDARD) == I2S_Standard_MSB) || ((STANDARD) == I2S_Standard_LSB) ||     \
...
#define IS_I2S_MCLK_OUTPUT(OUTPUT)                                             \
  (((OUTPUT) == I2S_MCLKOutput_Enable) || ((OUTPUT) == I2S_MCLKOutput_Disable))
/**
 * @}
 */
...
#define IS_SPI_I2S_GET_IT(IT)                                                  \
  (((IT) == SPI_I2S_IT_RXNE) || ((IT) == SPI_I2S_IT_TXE) ||                    \
   ((IT) == I2S_IT_UDR) || ((IT) == SPI_IT_CRCERR) || ((IT) == SPI_IT_MODF) || \
   ((IT) == SPI_I2S_IT_OVR))
/**
 * @}
 */
